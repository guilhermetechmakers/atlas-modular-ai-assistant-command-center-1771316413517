      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set up your workspace and connect integrations next.</CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={cn(errors.workspace && 'border-destructive focus:ring-destructive')}
                  {...register('workspace')}
                />
                {errors.workspace && (
